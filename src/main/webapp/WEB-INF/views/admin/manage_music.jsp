...
<section class="Hui-article-box">
  <nav class="breadcrumb"><i class="Hui-iconfont">&#xe681;</i> 内容管理 <span class="c-gray en">&gt;</span> 音乐 <span class="c-gray en">&gt;</span> 管理音乐 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    <article class="cl pd-20">
      <div class="cl pd-5 bg-1 bk-gray">
        <span class="l">
          ...
          <a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加音乐','./admin/music/add','800')">
            <i class="Hui-iconfont">&#xe600;</i> 添加音乐
          </a>
        </span>
        <span class="r">共有数据：
      ...
      <div class="mt-20">
        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
          <div id="DataTables_Table_0_filter" class="dataTables_filter">
            ...
            <label>从当前数据中检索：
              <input type="search" id="name" class="" placeholder="音乐" aria-controls="DataTables_Table_0">
          ...
          <tr class="text-c" role="row">
            ...
            <th width="60" class="sorting_disabled" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="标签: 升序排列" style="width: 100px;">歌曲名</th>
            <th width="100" class="sorting_disabled" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="标签: 升序排列" style="width: 100px;">所属专辑</th>
            <th width="100" class="sorting_disabled" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="标签: 升序排列" style="width: 100px;">歌曲时长</th>
    ...
    $.ajax({
      ...
      success:function(data){
        ...
        $.each(data.allList,function (index,obj){
          ...
          htmlStr+="<td><input type=\"checkbox\" id=\""+obj.mid+"\" name=\""+obj.mid+"\"></td>";
          htmlStr+="<td>"+obj.mid+"</td>";
          htmlStr+="<td>"+obj.name+"</td>";
          htmlStr+="<td>"+obj.title+"</td>";
          htmlStr+="<td>"+obj.min+"</td>";
          htmlStr+="<td class=\"td-manage\"> <a title=\"编辑\" href=\"javascript:;\" onclick=\"admin_role_edit('编辑','./admin/music/edit?mid="+obj.mid+"','4','','510')\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\"></i></a></td>";
          htmlStr+="</tr>";
        });
        $("#tBody").html(htmlStr);
