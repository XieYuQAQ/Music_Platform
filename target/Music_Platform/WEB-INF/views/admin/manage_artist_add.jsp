...
<article class="cl pd-20">
    <form method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-admin-role-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="dob" name="生日" datatype="*4-16">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="about" name="介绍" datatype="*4-16">
                <p>请填写关于艺人的介绍。</p>
            </div>
        </div>
        <div class="row cl">
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        if (data.code == "1") {
                            ...
                            $.ajax({
                                url: 'admin/artist/imagef.do?aid=' + data.returnData,
                                data: formData,
                                processData: false,
                                contentType: false,
                                type: 'post',
                                ...
                                success: function () {
                                    if (data.code == "1") {
                                        ...
                                        $.ajax({
                                            url: 'admin/artist/image.do?aid=' + data.returnData,
                                            data: formData,
                                            processData: false,
                                            contentType: false,
                                            type: 'post',
